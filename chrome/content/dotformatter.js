const DOTFORMATTER_ID = 'emidiostani@gmail.com';

function initializexmlformatterObserver()
{
    dotformatterObserver.register();
}

var dotformatterObserver =
{
    _uninstall: false,
        ...
        else if(topic == "quit-application-granted")
        {
            ...
            { // your uninstall stuff goes here
                ...
                if(typeof current_ppf != "undefined")
                {
                    ...
                    {
                        if(split_ppf[ppf].search("chrome://dotformatter/content/formats/Dot-formatter.js") != -1)
                        {
                ...
                branch.deleteBranch('dotformatter'); // remove custom branch

                // Remove custom branch
                branch.deleteBranch('formats.dotformatter'); // remove custom branch
            }
            this.unregister();
        }
    }, register: function()
...
window.addEventListener("load", initializedotformatterObserver, false);
